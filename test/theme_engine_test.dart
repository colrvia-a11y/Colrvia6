...
void main() {
  ...
  test('ThemeEngine prefilter and hints and scoring for coastal', () async {
    ...
    final paints = <Paint>[
      Paint.fromJson({'hex': '#f6f7f8', 'lab': [95,0,0], 'lch': [92,1,200], 'rgb': [246,247,248], 'brandName': 'A'}, 'p1'),
      Paint.fromJson({'hex': '#1f5f6f', 'lab': [30,10,10], 'lch': [40,15,190], 'rgb': [31,95,111], 'brandName': 'B'}, 'p2'),
      Paint.fromJson({'hex': '#004488', 'lab': [30,40,20], 'lch': [30,45,210], 'rgb': [0,68,136], 'brandName': 'C'}, 'p3'),
      Paint.fromJson({'hex': '#ff00ff', 'lab': [50,60,40], 'lch': [50,75,300], 'rgb': [255,0,255], 'brandName': 'D'}, 'p4'),
    ];
  ...
  final coastalPalette = [filtered.first, filtered.length > 1 ? filtered[1] : filtered.first, filtered.first];
