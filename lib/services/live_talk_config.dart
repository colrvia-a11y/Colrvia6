...
class LiveTalkConfig {
  ...
  static const bool useLocalSignaling =
      bool.fromEnvironment('USE_LOCAL_SIGNALING', defaultValue: false);
  static const String localHost =
      String.fromEnvironment('LOCAL_SIGNALING_HOST', defaultValue: '10.0.2.2');
  static const int localPort =
      int.fromEnvironment('LOCAL_SIGNALING_PORT', defaultValue: 8080);

  // If you run a production reverse proxy (e.g., talk.colrvia.com), set this via dart-define.
  static const String prodHost = String.fromEnvironment('PROD_SIGNALING_HOST',
